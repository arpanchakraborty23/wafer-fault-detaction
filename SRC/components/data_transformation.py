...
class DataTransformationConfig:
        preprocess_file_path=os.path.join('preprocess','preprocess.pkl') # process data file path
...
class DataTransformation:
    ...
    def initiate_data_transformation(self,train_data_path,test_data_path):
        try:
            ...
            input_features_train_df=train_df.drop([target_column_name,drop_column],axis=1) # X
            target_features_train_df=train_df[target_column_name] #Y

            # Test data X y define
            input_features_test_df=test_df.drop(columns=[target_column_name,drop_column],axis=1) # X
            target_features_test_df=test_df[target_column_name] #Y
